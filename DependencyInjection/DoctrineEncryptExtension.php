...
namespace Jurv\DoctrineEncryptBundle\DependencyInjection;
...
class DoctrineEncryptExtension extends Extension {
    ...
    public function load(array $configs, ContainerBuilder $container) {
        ...
        //Set parameters
        $container->setParameter('jurv_doctrine_encrypt.encryptor_class_name', $config['encryptor_class']);
        $container->setParameter('jurv_doctrine_encrypt.secret_key', $config['secret_key']);
