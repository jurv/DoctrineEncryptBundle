...
* Optional parameter [encryptor]
    * An encryptor provided by the bundle (AEADxChaCha20Poly1305) or your own [encryption class](https://github.com/jurv/DoctrineEncryptBundle/blob/master/Resources/doc/custom_encryptor.md).
...
```
$ php app/console doctrine:encrypt:database \Jurv\DoctrineEncryptBundle\Encryptors\AEADxChaCha20Poly1305Encryptor
```
