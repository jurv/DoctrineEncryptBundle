...
namespace Jurv\DoctrineEncryptBundle\Subscribers;
...
class DoctrineEncryptSubscriber implements EventSubscriber {
     ...
     */
    const ENCRYPTOR_INTERFACE_NS = 'Jurv\DoctrineEncryptBundle\Encryptors\EncryptorInterface';

    /**
     * Encrypted annotation full name
     */
    const ENCRYPTED_ANN_NAME = 'Jurv\DoctrineEncryptBundle\Configuration\Encrypted';
